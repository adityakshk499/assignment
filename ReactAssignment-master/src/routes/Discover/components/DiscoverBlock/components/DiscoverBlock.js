...
export default function DiscoverBlock({ text, id, data,imagesKey=false}) {
  return (
    <div className="discover-block">
      ...
      <div className="discover-block__row" id={id}>
        {data.map(item => 
          ...
          (<DiscoverItem key={item.name} images={imagesKey===false?(item.images):(item.icons)} name={item.name} />)
